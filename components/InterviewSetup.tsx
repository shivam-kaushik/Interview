...
export default function InterviewSetup({ onComplete }: InterviewSetupProps) {
  ...
  const canProceedStep2 = true; // Resume is optional
  const canStart = true;
      ...
      >
        ...
        {step === 1 && (
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-48 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#407BBF] focus:border-transparent resize-none"
            />
            <div className="flex justify-end mt-6">
              <button
                ...
                className={`px-6 py-2 rounded-full font-medium ${
                  canProceedStep1
                    ? "bg-[#1E2B3A] text-white hover:bg-[#2a3f5f]"
        ...
        {step === 2 && (
          ...
          >
            ...
            <div
              ...
              className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-[#407BBF] transition-colors"
            >
              <input
                ref={fileInputRef}
                type="file"
              ...
              {isUploading ? (
                <div className="flex items-center justify-center">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#407BBF]"></div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 font-medium">{resumeFileName}</p>
                ...
                <div>
                  ...
                  <p className="text-gray-700">Click to upload PDF, DOCX, or TXT</p>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="w-full h-32 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#407BBF] focus:border-transparent resize-none text-sm"
              />
            </div>
            ...
            <div className="flex justify-between mt-6">
              <button
                onClick={() => setStep(1)}
                className="px-6 py-2 rounded-full font-medium text-gray-600 hover:bg-gray-100"
              >
                Back
              </button>
              <button
                onClick={() => setStep(3)}
                className="px-6 py-2 rounded-full font-medium bg-[#1E2B3A] text-white hover:bg-[#2a3f5f]"
              >
                Continue
              </button>
            </div>
        ...
        {step === 3 && (
          ...
          >
            ...
            <div className="mb-6">
              <h3 className="font-medium text-gray-700 mb-3">Interview Type</h3>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 text-left transition-all ${
                      selectedType.id === type.id
                        ? "border-[#407BBF] bg-blue-50"
                        : "border-gray-200 hover:border-gray-300"
                    }`}
                  >
                    <p className="font-medium text-[#1E2B3A]">{type.name}</p>
            ...
            <div className="mb-6">
              <h3 className="font-medium text-gray-700 mb-3">Select Interviewer</h3>
              <div className="grid grid-cols-3 gap-3">
                {interviewers.map((interviewer) => (
                  ...
                  >
                    ...
                    <p className="font-medium text-[#1E2B3A]">{interviewer.name}</p>
            ...
            <div className="flex justify-between mt-8">
              ...
              <button
                onClick={handleStart}
                className="px-8 py-3 rounded-full font-medium bg-[#407BBF] text-white hover:bg-[#3569a3] flex items-center"
              >
                Start Interview
